...
const ProjectRed = ({ item }) => {
    return (
        <div>
            <div key={item.id}>
                <div className='flex flex-col w-[299px] h-[410px] rounded-t-[15px] bg-[#F6F6F6] mt-[20px] mb-[20px]'>
                    ...
                    <div className='flex flex-col p-[30px] gap-[20px] w-full h-[246px]'>
                        ...
                        <p className='w-[222px] h-[57px] text-[16px] leading-[19px] font-normal'>{item.details}</p>
