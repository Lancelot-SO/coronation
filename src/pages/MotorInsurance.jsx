                    ...
                    <div className=' flex items-end justify-end'>
                        <div className='w-[1350px] h-[552px] mt-[80px] flex relative'>
                            <div className='mt-[50px] flex flex-col mr-[30px] large:ml-[20px]'>
                                ...
                                <div className=''>
                                    <button type='button' onClick={() => setShowCallModal(true)} className='flex items-center gap-2 w-[222px] h-[44px] hover:text-customPurple'>
                            ...
                            <div className='relative flex items-center'>
                                ...
                                <img src={motorComp} alt='history' className='absolute w-[600px] h-[391px] object-cover top-[80px] right-[20%]' />
                            </div>

                        </div>
                    </div>
                    <Link to="https://ecoronation.com/motor" target="_blank" rel="noopener noreferrer" className='flex ml-[650px] items-center justify-center bg-customPurple text-white w-[222px] h-[44px]'>
                        GET A QUOTE
                    </Link>
                </div>
            </section>
                ...
                <div className='bg-[#F1F5F9] w-full h-[694px] flex flex-col'>
                    <div className='w-[1300px] h-[552px] flex relative'>
                        ...
                        <div className='mt-[70px] flex flex-col ml-4 3xl:ml-11'>
                            ...
                            <div className=''>
                                <button type='button' onClick={() => setShowPartyModal(true)} className='flex items-center gap-2 w-[222px] h-[44px] hover:text-customPurple'>
                                    <span>Insurance Features</span>
                                    <FaLongArrowAltRight className='mt-[5px]' />
                                </button>
                    ...
                    <Link to="https://ecoronation.com/motor" target="_blank" rel="noopener noreferrer" className='flex ml-[650px] mt-[100px] items-center justify-center bg-customPurple text-white w-[222px] h-[44px]'>
                        GET A QUOTE
                    </Link>
                </div>
            </section>
                ...
                <div className='bg-[#F1F5F9] w-full h-[600px] flex flex-col'>
                    <div className=' flex items-end justify-end'>
                        <div className='w-[1350px] h-[552px] flex relative'>
                            ...
                            <div className='relative flex items-center'>
                                <div className='bg-black w-[871px] h-[286px]'></div>
                                <img src={motorComp2} alt='history' className='absolute w-[600px] h-[391px] object-cover top-[80px] right-[20%]' />
                            </div>
                ...
                <div className='bg-[#F1F5F9] flex items-center 3xl:h-[720px] large:h-[680px]  justify-center h-screen'>
                    <div className='relative flex w-[1200px] h-[626px]'>
                        <div className='flex flex-col mt-[100px] z-10'>
                            ...
                            <Link to="https://ecoronation.com/motor" target="_blank" rel="noopener noreferrer" className='w-[179px] h-[50px] bg-customPurple text-white mt-4 flex items-center justify-center'>
                                GET A QUOTE
                            </Link>
                        </div>
