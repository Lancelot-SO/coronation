        ...
        <div>
            <div className='relative'>
                ...
                <div className='absolute top-[303px] left-[160px] w-[745px] h-[165px] bg-[rgba(0,0,0,0.8)] p-10'>
                    <h2 className='mb-4 text-[31px] leading-[37px] text-white font-normal'>Corporate Insurance</h2>
                ...
                <div className='absolute top-[181px] left-[1000px] 3xl:ml-[230px]'>
                    ...
                    <Link to="/contact" className='absolute top-[300px] items-center justify-center'>
                        <button className='flex w-[263px] h-[45px] items-center gap-4 bg-secondary ml-[20px] justify-center text-white rounded-[30px]'>Corporate Account <MdWifiCalling3 /></button>
                    </Link>
                </div>
                ...
                <div className='bg-[#F1F5F9] w-full h-[794px] flex items-center justify-end'>
                    <div className='w-[1350px] h-[552px] flex relative'>
                        <div className='mt-[120px] flex flex-col 3xl:ml-[-30px] large:ml-[40px]'>
                            ...
                            <Link to="https://claims-gh.coronation.ng/" target='_blank' rel='noopener noreferrer' className='w-[179px] h-[50px] bg-secondary text-white mt-4 flex items-center justify-center'>
                                MAKE A CLAIM
                            </Link>
                        </div>
