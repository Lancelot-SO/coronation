                    ...
                    <div className=' w-[1123px] h-[940px] mt-[30px] flex gap-4'>
                        <div>
                            <div className=' w-[664px] h-[303px]'>
                                <p className='w-[664px]  font-normal h-[120px] leading-[24px] text-[16px] text-[#666C89]'>
                                ...
                                <h2 className='h-[36px] font-normal text-[20px] leading-[36px] text-black mb-2'>
                            ...
                            <div className='w-[664px] mt-4 '>
                                ...
                                <p className='w-[664px]  font-normal leading-[24px] h-[120px] text-[16px] text-[#666C89] mb-8'>
                                    Let us start with the essentials. By law, every vehicle
                                    on the road needs at least third-party motor
                                    insurance. This covers any injuries or damage you
                                    cause to others with your vehicle. It's the foundation,
                        ...
                        <div>
                            <div className='min-w-[440px] min-h-[304px] bg-[#F5F5F5]'>
                                <h2 className='h-[60px] font-normal text-[20px] leading-[36px] text-black mb-2'>
