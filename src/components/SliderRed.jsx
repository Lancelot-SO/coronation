                ...
                <div className='w-[450px] h-[163px] mt-[100px] pl-8'>
                    <div className='flex flex-col mb-[80px]'>
                        ...
                        <p className='w-[450px] h-[127px] font-normal text-[16px] leading-[30px]'>
                            <b className='text-[30px] text-secondary'>“</b> Id urna, nisl, ut quam. Diam suspendisse fringilla quam arcu mattis est velit in. Nibh in purus sit convallis phasellus ut. At vel erat ultricies commodo. Neque suspendisse a habitasse commodo. <b className='text-[30px] text-secondary'>”</b>
                        </p>
                    </div>
