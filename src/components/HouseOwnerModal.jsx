            ...
            <div class="call__modal-content">
                <div class="relative flex flex-col items-center justify-center main__shadow w-screen h-auto p-4">
                    ...
                    <ul className="relative z-10 top-[30px] p-2 bg-white rounded-2xl space-y-1 text-black">
                        ...
                        <li class="w-full font-normal text-[14px] leading-[32px]">•  All risk coverage is for laptops, jewelry, and   other moveable items. Customer cannot take insurance cover for all risk items<br />alone. It must be taken along side Home owners cover.</li>
...
export default HouseOwnerModal