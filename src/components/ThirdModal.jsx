            ...
            <div className="call__modal-content">
                <div className="relative flex flex-col items-center justify-center main__shadow w-screen h-auto p-4">
                    ...
                    <ul className="relative z-10 top-[100px] shadow p-2 bg-gray-800 bg-opacity-75 rounded-2xl space-y-1 text-black">
                        ...
                        <li className="w-full font-normal text-[14px] leading-[32px]">• Third party bodily injury & death - unlimited</li>
                        <li className="w-full font-normal text-[14px] leading-[32px]">• Third party property damage limit: GHS6,000</li>
                        <li className="w-full font-normal text-[14px] leading-[32px]">• 7. Reimbursement of legal fees if policy holder is<br /> prosecuted in court over an accident resulting in a valid<br /> claim</li>
